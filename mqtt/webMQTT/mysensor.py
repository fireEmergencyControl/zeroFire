        ...
        try:
            while True:
                if gpio.input(self.pir_pin) == 1:             
                    ...
                    publish.single("iot:pir","motion detected",hostname="172.30.1.21") # ,hostname="172.30.1.55"
                else:                   
                    print("no motion....")
                time.sleep(1) 
